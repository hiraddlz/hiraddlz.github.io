...
Results-driven AI/ML professional with 3+ years of experience in developing and deploying scalable machine learning solutions across diverse domains. Specialized in generative AI and predictive modeling, with technical proficiency in PyTorch, Keras, and AWS. Combines hands-on engineering expertise with strategic business insights from an MBA (GPA: 4.0). Certified in AI (Cornell) and Generative AI Engineering. Proven track record of delivering end-to-end ML solutions that align technical performance with business impact.
...
### Machine Learning Engineer
**Fanap Plus / Gereh** | Dec 2021 – Mar 2023

- Built and maintained ETL pipelines, managing datasets for business intelligence purposes.
- Developed a web-based dashboard to visualize the analysis results and KPIs, facilitating data-driven decision-making for marketing strategies.
...
**Bachelor of Science – Civil Engineering** | Sharif University of Technology | Sep 2012 – Feb 2017
- GPA: 3.49/4.0
